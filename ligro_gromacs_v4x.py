...
-------------------
"""
title = 'LiGRO: Version 0.2 - For GROMACS 4.x'
...
class GUI:
    ...
    def mount_simulation_lig(self):
        ...
        os.system('''
                    ...
                    ''')
        os.system('grompp -f em.mdp -c trpb4ion.pdb -p trp.top -o ion.tpr')
        ...
        if inte == 'SD Algorithm':
            os.system(cmd3)
            os.system('grompp -f em_real.mdp -c trpb4em.pdb -p trp.top -o em.tpr')
            ...
            os.system('mdrun -v -deffnm em')
            os.system(cmd4)
            os.system('grompp -f em_real.mdp -c em.gro -p trp.top -o em.tpr')
            os.system('mdrun -v -deffnm em')
            os.system('''
                        make_ndx -f em.gro -o index2.ndx << EOF
                        "Protein" | "Other"
        ...
        os.system("echo 'grompp -f nvt.mdp -c em.pdb -p trp.top -o nvt.tpr' >> queue.sh")
        os.system("echo  'mdrun -v -deffnm nvt' >> queue.sh")
        os.system("echo 'grompp -f npt.mdp -c nvt.gro -p trp.top -o npt.tpr' >> queue.sh")
        os.system("echo 'mdrun -v -deffnm npt' >> queue.sh")
        os.system("echo 'grompp -f md.mdp -c npt.gro -p trp.top -o md.tpr' >> queue.sh")
    ...
    def simulation_LIE_complex(self):
        ...
        os.system('grompp -f nvt.mdp -c em.pdb -p trp.top -o nvt.tpr')
...
Ligand   1
        ...
        liecmd1 = 'editconf -bt {0} -f Ligand.gro -o trpb4solv.pdb -d {1}'.format(bx, dst)
        os.system(liecmd1)
        os.system('genbox -cp trpb4solv.pdb -cs spc216.gro -o trpb4ion.pdb -p topol.top')
        os.system('''
        cat << EOF >| em.mdp
; LINES STARTING WITH ';' ARE COMMENTS
title		= Minimization	; Title of run
...
pbc             = xyz 		; Periodic Boundary Conditions
                    ''')
        os.system('grompp -f em.mdp -c trpb4ion.pdb -p topol.top -o ion.tpr')
        ...
        if self.ion_menu.getcurselection() == 'Na':
            ...
            c_ion = '-conc ' + self.ion_cc.getvalue()
        liecmd2 = 'echo SOL|genion -s ion.tpr -o trpb4em.pdb -neutral {} -p topol.top'.format(c_ion)
        os.system(liecmd2)
...
pbc		    = xyz 		; Periodic Boundary Conditions (yes/no)
        ...
        if lie_inte == 'SD Algorithm':
            os.system(liecmd3)
            os.system('grompp -f em_real.mdp -c trpb4em.pdb -p topol.top -o em.tpr')
            os.system('mdrun -v -deffnm em')
            os.system('''
            trjconv -f em.gro -s em.tpr -pbc nojump -ur compact -center -o em_2.gro << EOF
            Other
            ...
            os.system('mdrun -v -deffnm em')
            os.system(liecmd4)
            os.system('grompp -f em_real.mdp -c em.gro -p topol.top -o em.tpr')
            os.system('mdrun -v -deffnm em')
            os.system('''
                        trjconv -f em.gro -s em.tpr -pbc nojump -ur compact -center -o em_2.gro << EOF
                        Other
        ...
        os.system('''
                        ...
                        q
                        EOF ''')
        os.system('grompp -f nvt2.mdp -c em.pdb -p topol.top -o nvt2.tpr -n index2.ndx')
        os.system('mdrun -v -deffnm nvt2')
    ...
    def lie_calculation(self):
        try:
            ...
            pass
        com1= '''echo 44 45 0 | g_energy -f nvt.edr > saida1.txt'''
        os.system(com1)
        com2= '''echo 42 43 0 | g_energy -f nvt2.edr > saida2.txt'''
        os.system(com2)
        ...
        os.system('g_lie -f nvt.edr -o lie_comp.xvg -ligand LIG -Eqq {0} -Elj {1} > out1.txt'.format(coull,ljj))
        os.system('g_lie -f nvt2.edr -o lie_lig.xvg -ligand LIG -Eqq {0} -Elj {1} >> out1.txt'.format(coull2,ljj2))
...
---------------------------------------------
            ...
            os.system(command)
            pj = str(self.project.getvalue())
            an5 = 'hbond_{0}.xvg'.format(pj)
            shutil.copy('hbond.xvg', an5)
            directory = str(self.save.getvalue())
            shutil.copy2(an5, directory)
            ...
            com1= '''echo 56 57 0 | g_energy -f md_an.edr > saida.txt'''
            os.system(com1)
